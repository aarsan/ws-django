...
<div id="content">
    ...
    <h2>Please enter an amount and description</h2>
        ...
        <input type="hidden" name="payer" value="<?php echo $member_ID; ?>" />
        <input type="hidden" name="payee" value="<?php echo $_SESSION['member_ID']; ?>">
            <table id="table-1">
                    <tr>
                        <td>Member you received payment from:</td> 
